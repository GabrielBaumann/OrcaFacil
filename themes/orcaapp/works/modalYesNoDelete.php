    ...
    <div class="modal-overlay" id="confirmationModal">
        <div class="modal-content">
            ...
            <div class="modal-buttons">
                <form action="<?= url("/deletargastos"); ?>">
                    <input type="hidden" value="<?= $category; ?>" name="category">
                    <input type="hidden" value="<?= $idexpenses; ?>" name="idexpense">
                    <input type="hidden" value="<?= $budget; ?>" name="budget">
                    <input type="hidden" value="<?= $idwork; ?>" name="idwork">
                    <button
                        type="submit" 
                        id="btn-add-expenses" 
                ...
                <button class="modal-button cancel-button" id="close-btn">
                    cancelar
                </button>
            </div>
        </div>
