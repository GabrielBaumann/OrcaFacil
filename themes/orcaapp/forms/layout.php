...
<body class="bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 flex flex-col min-h-screen font-sans pb-16 sm:pb-0">
    ...
    <header class="h-16 border-b border-gray-200 dark:border-gray-600 px-4 sm:px-6 flex items-center justify-between sticky top-0 bg-white dark:bg-gray-800 z-10">
        <div class="flex items-center space-x-4">
            <a href="<?= $default->url ?? null ?>" class="p-1 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
    ...
    <main class="flex-grow w-full max-w-4xl mx-auto px-4 sm:px-6 py-6">
        ...
        <nav class="flex mb-6" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                <li class="inline-flex items-center">
                    <a href="<?= $default->url ?? null ?>" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ml-2"><?= $default->titleForms ?? null ?></span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="mb-6">
            <h2 class="text-2xl font-semibold"><?= $default->titleForms ?? null ?></h2>
            <p class="text-gray-500 dark:text-gray-400 mt-1"><?= $default->textForms ?? null ?></p>
        </div>
    ...
    <script src="<?= theme("/assets/js/default/forms.js", CONF_VIEW_APP)?>"></script>
